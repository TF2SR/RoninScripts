...
void function InitSinglePlayerMenu()
{
	...
	AddMenuFooterOption( menu, BUTTON_Y, "%[Y_BUTTON|]% Practice Warps", "Practice Warps", SRM_OpenPracticeWarpsMenu)
}

void function SRM_OpenPracticeWarpsMenu(var button)
{
	AdvanceMenu( GetMenu( "SRM_PracticeWarpsMenu" ) )
}
